...
要想使模块内的getter, mutation,action注册在**模块命名空间**,必须在模块内加上 **namespaced: true**

**使用命名空间**

![img](https://upload-images.jianshu.io/upload_images/3297464-9fb25a7638a0b1fd.jpeg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1000/format/webp) 

**未使用命名空间**

![img](C:\Users\admin\Desktop\webp)
